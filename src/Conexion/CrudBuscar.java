...
public class CrudBuscar {
    ...
    public DefaultTableModel MostrarFiltro(Modelo.ModeloBuscar dts) {
        ...
        try {
            csta = cn.prepareCall("{call sp_BuscarDocumentoFiltro(?,?,?)}");
            ...
            while (rs.next()) {
                ...
                Registro[12] = rs.getString("NombreAutor3");
                Registro[13] = rs.getString("CodigoAutor3");
    ...
    public DefaultTableModel Mostrar() {
        ...
        modelo = new DefaultTableModel(null, Titulos);
        try {
            csta = cn.prepareCall("{call sp_BuscarDocumento}");
