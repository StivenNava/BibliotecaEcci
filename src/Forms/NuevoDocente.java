...
public class NuevoDocente extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        val = func.ValCodigoDocente(TxtCodigo.getText());
        
        if (val.equals("1")){
            JOptionPane.showMessageDialog(null, "El Docente ya existe en la Base de datos");   
        }
            ...
            if(response){
                ...
                JOptionPane.showMessageDialog(null, "Error en la creación del Docente");
            }
        }
        else{
                JOptionPane.showMessageDialog(null, "Error en la creación del Docente");
